...
public:
    PersMessage();
    string getCharValue(int fieldNumber) const;   // геттер для вывода полей класса типа stringt
    void setValue(int numValue, string value);    // сеттер для инициализации полей типа string
